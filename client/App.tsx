...
let Layout, Marketplace, SupplierStore, Messages, PlaceholderPage, NotFound;

try {
  Layout = require("./components/Layout").default;
  Marketplace = require("./pages/Marketplace").default;
  SupplierStore = require("./pages/SupplierStore").default;
  Messages = require("./pages/Messages").default;
  PlaceholderPage = require("./pages/PlaceholderPage").default;
  NotFound = require("./pages/NotFound").default;
} catch (error) {
  console.error("Error importing components:", error);
  // Fallback components
  Layout = ({ children }: { children: React.ReactNode }) => <div>{children}</div>;
  Marketplace = () => <div>Marketplace (Error in import)</div>;
  SupplierStore = () => <div>Supplier Store (Error in import)</div>;
  Messages = () => <div>Messages (Error in import)</div>;
  PlaceholderPage = () => <div>Placeholder (Error in import)</div>;
  NotFound = () => <div>Not Found (Error in import)</div>;
}
